...
#else
enum {DLLNO_D2CLIENT, DLLNO_D2COMMON, DLLNO_D2GFX, DLLNO_D2LANG, DLLNO_D2WIN, DLLNO_D2NET, DLLNO_D2GAME, DLLNO_D2LAUNCH, DLLNO_FOG, DLLNO_BNCLIENT, DLLNO_STORM, DLLNO_D2CMP, DLLNO_D2MULTI, DLLNO_D2SIGMA};
...
//FUNCPTR(D2CLIENT, LeftClickItem_I, void __stdcall, (UnitAny* pPlayer, Inventory* pInventory, int x, int y, DWORD dwClickType, InventoryLayout* pLayout, DWORD Location), 0x96AA0) // 1.12
...
VARPTR(D2CLIENT, pTransactionDialogsInfo, TransactionDialogsInfo_t*, 0x11BC00)
...
/*
CE search 8B 44 24 0C 8B 54 24 04 8B 49 04 FF 30

D2Sigma.dll+C35B0 - 8B 44 24 0C           - mov eax,[esp+0C]
D2Sigma.dll+C35B4 - 8B 54 24 04           - mov edx,[esp+04]
D2Sigma.dll+C35B8 - 8B 49 04              - mov ecx,[ecx+04]
D2Sigma.dll+C35BB - FF 30                 - push [eax]
D2Sigma.dll+C35BD - 8B 44 24 0C           - mov eax,[esp+0C]
D2Sigma.dll+C35C1 - 8B 12                 - mov edx,[edx]
D2Sigma.dll+C35C3 - FF 30                 - push [eax]
D2Sigma.dll+C35C5 - 6A 03                 - push 03 { 3 }
D2Sigma.dll+C35C7 - E8 6463FBFF           - call D2Sigma.dll+79930     <--------------- leftClick
D2Sigma.dll+C35CC - C2 0C00               - ret 000C { 12 }

D2Sigma.dll+C35D0 - 8B 44 24 0C           - mov eax,[esp+0C]
D2Sigma.dll+C35D4 - 8B 54 24 04           - mov edx,[esp+04]
D2Sigma.dll+C35D8 - 8B 49 04              - mov ecx,[ecx+04]
D2Sigma.dll+C35DB - FF 30                 - push [eax]
D2Sigma.dll+C35DD - 8B 44 24 0C           - mov eax,[esp+0C]
D2Sigma.dll+C35E1 - 8B 12                 - mov edx,[edx]
D2Sigma.dll+C35E3 - FF 30                 - push [eax]
D2Sigma.dll+C35E5 - 6A 03                 - push 03 { 3 }
D2Sigma.dll+C35E7 - E8 846EFBFF           - call D2Sigma.dll+7A470    <-------------rightClick
D2Sigma.dll+C35EC - C2 0C00               - ret 000C { 12 }

*/
FUNCPTR(D2SIGMA, ClickItemLeft_I, DWORD __fastcall, (UnitAny* MyUnit, DWORD unk, DWORD Location, DWORD y, DWORD x), 0x79930)
FUNCPTR(D2SIGMA, ClickItemRight_I, DWORD __fastcall, (UnitAny* MyUnit, DWORD unk, DWORD Location, DWORD y, DWORD x), 0x7A470)
...
#define D2CLIENT_MercItemAction(bPacketType, dwSlotId)	D2CLIENT_MercItemAction_ASM(bPacketType, dwSlotId)
#define D2CLIENT_SendGamePacket(dwLen, bPacket)			D2CLIENT_SendGamePacket_ASM(dwLen, bPacket)
#define D2SIGMA_LeftClickItem(pPlayer, loc, x, y)		D2SIGMA_LeftClickItem_ASM(pPlayer, GetUnkStruckByLocation(loc), loc, x, y)
#define D2SIGMA_RightClickItem(pPlayer, loc, x, y)		D2SIGMA_RightClickItem_ASM(pPlayer, GetUnkStruckByLocation(loc), loc, x, y)
